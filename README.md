...
| --- | -------------------------------- | --------------------------------------------- | ----- |
| 00  | [Setup & ROI mindset](modules/00-setup.md) | Maximize token value                          | 🟢    |
...
| 06  | [Lever 4 : Workflow design](modules/06-workflow-design.md) | Research → Plan → Implement                   | 🟡    |
...
| 09  | [Power-user tips](modules/09-power-user-tips.md) | Scripting, filtering, usage analysis          | 🔴    |
